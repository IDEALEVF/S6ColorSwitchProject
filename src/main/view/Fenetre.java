...
public class Fenetre extends Application implements Observer{
    ...
    public void setBtnv(boolean btnv) {
    	this.btnv = btnv;
    }
...
//
//        Form deco4 = (Form)FormsFactory.build("CarreBleu", -getLargeurFenetre()/10,
//        		getHauteurFenetre()/12,getLargeurFenetre()/2 , 8, 3, -45);
//        level.getObjects().addElement(deco4);
//
//        Form deco5 = (Form)FormsFactory.build("CarreRose", 7*getLargeurFenetre()/10,
//        		getHauteurFenetre()/12,getLargeurFenetre()/2 , 8, 3, 45);
//        level.getObjects().addElement(deco5);
//
//        Form deco6 = (Form)FormsFactory.build("CarreJaune", -getLargeurFenetre()/10,
//        		10*getHauteurFenetre()/12,getLargeurFenetre()/2 , 8, 3, 45);
//        level.getObjects().addElement(deco6);
//
//        Form deco7 = (Form)FormsFactory.build("CarreMauve", 7*getLargeurFenetre()/10,
//        		10*getHauteurFenetre()/12,getLargeurFenetre()/2 , 8, 3, -45);
//        level.getObjects().addElement(deco7);
