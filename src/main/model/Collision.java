...
public class Collision {
	...
	public boolean isCol() throws ClassNotFoundException{
		...
		for (Form it : formes){
			...
			if(!it.getClass().equals(Class.forName("main.model.forms.MessageColorSwitch"))){
				//on récupère les shapes de it
				listeShape=it.getShape();
				bal1=balle.getCircle();
				//bal1=balle.getCircle();
				System.out.println(it.getClass());


					if (!it.equals(balle) && !it.equals(doi)
							&& !it.getClass().equals(Class.forName("main.model.forms.Etoile"))
							&& !it.getClass().equals(Class.forName("main.model.forms.ChangeColor"))
							&& !it.getClass().equals(Class.forName("main.model.forms.Road"))
							&& !it.getClass().equals(Class.forName("main.model.forms.MessageColorSwitch"))) {//pas la balle, le doigt, l'étoile et le changecouleur
						//si collision
